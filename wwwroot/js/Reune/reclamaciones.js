...
$('input[name=estatus-radio]').on('change', function () {
    if ($('input[name=estatus-radio]:checked').val() === "1") {
        $("#RecFechaAtencion").prop('disabled', true);
        $("#RecFechaAbonoImporte").prop('disabled', true);
        $("#RecFechaResolucion").prop('disabled', true);
        $("#RecFechaNotifiUsuario").prop('disabled', true);
        $('#RecImporteAbonado').prop('disabled', true);
        $('#RecFechaAbonoImporte').prop('disabled', true);
        $('#RecSentidoResolucion').prop('disabled', true);
        $('#niveles-select').prop('disabled', true);
    } else {
        $("#RecFechaAtencion").prop('disabled', false);
        $("#RecFechaAbonoImporte").prop('disabled', false);
        $("#RecFechaResolucion").prop('disabled', false);
        $("#RecFechaNotifiUsuario").prop('disabled', false);
        $('#RecImporteAbonado').prop('disabled', false);
        $('#RecFechaAbonoImporte').prop('disabled', false);
        $('#RecSentidoResolucion').prop('disabled', false);
...
function limpiarAgregarModal() {
    ...
    $('input[name=estatus-radio][value=2]').prop('checked', true);
    ...
    $('input[name=monetario-radio][value=SI]').prop('checked', true);
