...
$("#btn_agregarDatosFicticios").on('click', function () {
    ...
    $.each(CONSULTAS_FICTICIAS, function (index, consulta) {
        consulta.InstitucionClave = $("#institucion-clave").val();
        consulta.Sector = $("#sector").val();
        consulta.ConsultasFolio = generarFolio();
